...
namespace ArchaismDictionaryAndroidApp
{
    ...
    public class MainActivity : AppCompatActivity, ISurfaceHolderCallback, CameraSource.IPictureCallback, INetworkConnection
    {
        ...
        {
            base.SetTheme(Archaism_Dictionary_App.Droid.Resource.Style.splash);
            base.OnCreate(savedInstanceState);

            SetContentView(Archaism_Dictionary_App.Droid.Resource.Layout.activity_main);
        ...
        {
            cameraView = FindViewById<SurfaceView>(Archaism_Dictionary_App.Droid.Resource.Id.cameraView);
            freezeFrameImage = FindViewById<ImageView>(Archaism_Dictionary_App.Droid.Resource.Id.freezeframeView);
            captureButton = FindViewById<ImageButton>(Archaism_Dictionary_App.Droid.Resource.Id.captureButton);
            resultText = FindViewById<TextView>(Archaism_Dictionary_App.Droid.Resource.Id.resultText);
            unfreezeButton = FindViewById<ImageButton>(Archaism_Dictionary_App.Droid.Resource.Id.unfreezeButton);
            errorScreen = FindViewById<TextView>(Archaism_Dictionary_App.Droid.Resource.Id.errorText);
            retry = FindViewById<Button>(Archaism_Dictionary_App.Droid.Resource.Id.retry);
            loadingImage = FindViewById<ImageView>(Archaism_Dictionary_App.Droid.Resource.Id.loadingImage);
            loadingText = FindViewById<TextView>(Archaism_Dictionary_App.Droid.Resource.Id.loadingText);

            bottomBarOCR = FindViewById<Android.Support.Design.Internal.BottomNavigationItemView>(Archaism_Dictionary_App.Droid.Resource.Id.navigation_ocr);
            bottomBarDict = FindViewById<Android.Support.Design.Internal.BottomNavigationItemView>(Archaism_Dictionary_App.Droid.Resource.Id.navigation_dictionary);

            searchTopBackground = FindViewById<ImageView>(Archaism_Dictionary_App.Droid.Resource.Id.topBackground);
            searchInput = FindViewById<EditText>(Archaism_Dictionary_App.Droid.Resource.Id.dictionaryInput);
            searchWord = FindViewById<TextView>(Archaism_Dictionary_App.Droid.Resource.Id.dictionaryWord);
            searchDefinition = FindViewById<TextView>(Archaism_Dictionary_App.Droid.Resource.Id.dictionaryDefinition);
            search = FindViewById<Button>(Archaism_Dictionary_App.Droid.Resource.Id.searchButton);
